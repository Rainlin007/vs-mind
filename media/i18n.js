const MESSAGES = {
  en: {
    ...
    panel: {
      ...
      showLineMarker: 'Arrow',
      canvasBackground: 'Background',
      nodePaddingGroup: 'Node',
      nodePaddingX: 'Horizontal Padding',
      nodePaddingY: 'Vertical Padding',
      text: 'Text',
      note: 'Note',
      comment: 'Comment',
      hyperlink: 'Hyperlink',
      ...
      resetThemeHint: 'Restores canvas, line settings, and rainbow lines to theme defaults',
  ...
  'zh-cn': {
    ...
    panel: {
      ...
      resetThemeHint: '将画布、连线设置和彩虹线条恢复为主题默认值',
...
export function applyDomI18n() {
  ...
  const labels = {
    ...
    'label-theme-lines': 'panel.themeLines',
    'label-theme-template': 'panel.themeTemplate',
    'label-layout': 'panel.layout',
    'label-rainbow-lines': 'panel.rainbowLines',
    'label-bg-pattern': 'panel.bgPattern',
    'label-bg-pattern-color': 'panel.bgPatternColor',
    'label-line-style': 'panel.lineStyle',
    'label-line-color': 'panel.lineColor',
    'label-line-width': 'panel.lineWidth',
    'label-line-radius': 'panel.lineRadius',
    'label-show-line-marker': 'panel.showLineMarker',
    'label-canvas-bg-color': 'panel.canvasBackground',
    'label-node-padding': 'panel.nodePaddingGroup',
    'label-node-padding-x': 'panel.nodePaddingX',
    'label-node-padding-y': 'panel.nodePaddingY',
