const MESSAGES = {
  en: {
    ...
    panel: {
      ...
      resetThemeHint: 'Clears customizations and restores line style, background pattern, and rainbow lines to defaults',
  ...
  'zh-cn': {
    ...
    panel: {
      ...
      resetThemeHint: '清除自定义，并将线条形状、背景花纹和彩虹线条恢复为默认值',
